...
import { LogOutIcon, MenuIcon, LayoutDashboardIcon, Share2Icon, UploadIcon, ImageIcon } from "lucide-react";
            ...
            <div className="flex-none flex items-center space-x-4">
              {user && (
                <>
                  ...
                  <span className="text-sm truncate max-w-xs lg:max-w-md">{user.username || user.emailAddresses[0].emailAddress}</span>
